...
from jumpkart.views import startpage, home, productdetail, checkoutpage, addtocart, cartpage, decitemfromcart, \
    removeitemfromcart, home, signup, checklogin, register, logout, setCategory, payment_process, contactus, aboutus, mobile
